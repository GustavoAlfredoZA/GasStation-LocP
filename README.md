...
## Definition
This project came up thanks to a spontaneous idea, which our teacher mentioned to us that we had a good project with a future, so we decided to make an interface to improve the purchase of gasoline, reducing their money or reducing distance to buy it using data from the Energy Regulatory Commission, which will be downloaded through a script that we will make.
## Overall Objectives
